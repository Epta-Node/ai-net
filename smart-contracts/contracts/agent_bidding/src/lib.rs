...
pub use types::{
    ...
    BidsRevealedEvent, ContractAwardedEvent, DataKey, Escrow, RefundClaimedEvent, SealedBid,
    CLAIM_WINDOW_SECS, DEFAULT_BIDDING_DURATION_SECS, MAX_REPUTATION, PRICE_WEIGHT,
