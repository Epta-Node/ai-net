...
const Footer: React.FC = () => {
  ...
  // Ids keep the React keys stable across a language change; the labels no
  // longer are. Brand names (GitHub, Twitter, Discord) are not translated.
  const footerLinks = [
    {
      id: 'product',
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[12px] text-text-secondary/40 flex items-center gap-1">
            <Trans
              ...
              components={[<Heart key="heart" size={11} className="text-accent-purple" />]}
            />
          </p>
